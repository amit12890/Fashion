...
public class MyAccountActivityBkp extends Activity implements View.OnClickListener,View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utility.changeStatusBarColor(MyAccountActivityBkp.this);
        util = new Utility(MyAccountActivityBkp.this);
        preferences = new AppPreferences(MyAccountActivityBkp.this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getTag().toString()){
            case "account":
               // Intent accountIntent = new Intent(MyAccountActivityBkp.this,AccountInformationActivity.class);
                //startActivity(accountIntent);
                break;
            case "addresses":
                Intent addressIntent = new Intent(MyAccountActivityBkp.this,MyAddressFragment.class);
    ...
    private void getUserAccountData(){
        ...
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                final String response = new RestClient(MyAccountActivityBkp.this).getUserAccountData();
        ...
        if(RestClient.isNetworkAvailable(MyAccountActivityBkp.this, util))
        {
            t.start();
